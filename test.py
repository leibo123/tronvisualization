...
bodyStart = '<body><header class="default-header"><h1>TRON-41</h1></header><main class="container"><div class="table-responsive"><table class="table"><thead><tr><th></th><th>Player</th><th>Score</th><th>ELO</th></tr></thead><tbody>'
index = 0
for filename in glob.glob('*.txt'):
    ...
    bodyEnd = '</tbody></table></div><p id="date">Published on {0}</p></main></body></html>'.format(datetime.today().strftime("%b %d at %I:%M %p"))
